            ...
            <>
              <div className="input-group mb-3 w-100">
                ...
                <div className="form-floating flex-grow-1">
                  ...
                  />
                  <label htmlFor="selectedSalonId">
                    Salon ID (Admindan oling)
                  </label>
                </div>
              </div>
              <div className="input-group mb-3 w-100">
              ...
              <div className="input-group mb-3 w-100">
                ...
                <div className="form-floating flex-grow-1">
                  ...
                  />
                  <label htmlFor="masterPhone">Telefon raqam (+998)</label>
                </div>
              </div>
            </>
          )}
              ...
              <div className="input-group mb-3 w-100">
                ...
                <div className="form-floating flex-grow-1">
                  <input
                    ...
                    placeholder="Telefon raqam"
                  />
                  <label htmlFor="clientPhone">Telefon raqam (+998)</label>
                </div>
              </div>
            </>
          )}
          ...
          <div className="input-group mb-4 w-100">
            ...
            <div className="form-floating flex-grow-1">
              <input
                ...
                placeholder="Parol"
              />
              <label htmlFor="password">Parol yarating (min 6 ta)</label>
            </div>
          </div>
